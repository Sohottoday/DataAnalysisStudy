...
df_store = pd.read_csv('C:\\Users\\user\\Desktop\\Programing\\Github\\SelfStudy\\Python\\DataAnalysis\\All_in_one\\Practice\\marketing\\소상공인시장진흥공단_상가(상권)정보_경남_202012.csv', encoding='utf-8', delimiter='|')
