...
if not os.path.exists('tweetwatcha.csv'):
    tweetdata.to_csv('tweetwatcha.csv', index=False, mode='w', encoding='utf-8-sig')
else:
    tweetdata.to_csv('tweetwatcha.csv', index=False, mode='a', encoding='utf-8-sig', header=False)