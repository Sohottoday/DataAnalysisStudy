...
if not os.path.exists('tweetgajja.csv'):
    tweetdata.to_csv('tweetgajja.csv', index=False, mode='w', encoding='utf-8-sig')
else:
    tweetdata.to_csv('tweetgajja.csv', index=False, mode='a', encoding='utf-8-sig', header=False)